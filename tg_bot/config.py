...
class Config(object):
    ...
    # REQUIRED
    API_KEY = "--"
    OWNER_ID = "789296658"  # If you dont know, run the bot and do /id in your private chat with it
    OWNER_USERNAME = "RitomSengupta"

    # RECOMMENDED
    SQLALCHEMY_DATABASE_URI = 'sqldbtype://username:pw@hostname:port/db_name'  # needed for any database modules
    MESSAGE_DUMP = None  # needed to make sure 'save from' messages persist
    GBAN_LOGS = -1001566223162 #Channel ID here with -
    LOAD = []
